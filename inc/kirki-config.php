...
*/
Kirki::add_config( 'htmlTowordpress_options', array(
...
Kirki::add_field( 'htmlTowordpress_options', [
    'type'            => 'background',
...
Kirki::add_field( 'htmlTowordpress_options', [
    ...
    'description' => esc_html__( 'Homepage Banner', 'kirki' ),
...
Kirki::add_field( 'htmlTowordpress_options', [
    ...
    'label'       => esc_html__( 'Switch Field', 'kirki' ),
    'description' => esc_html__( 'Homepage Intro', 'kirki' ),
    'section'     => 'homepage_settings',
    'default'     => '1',
    'priority'    => 10,
    'choices'     => [
